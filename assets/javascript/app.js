$(document).ready(function(){
  ...
  var character = ["Master Chief", "Cortana", "Mario", "Kratos", "Link", "Bowser", "Solid Snake", "Niko Bellic", "Agent 47"]
  GIFArea = " "
  ...
  var character1 = $("#character-input").val().trim();
  
  //this movie from the textbox is then added to our array
  character.push(character1);
